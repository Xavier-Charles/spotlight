...
export default function Projects() {
  return (
    <SimpleLayout
      ...
      intro="I’ve worked on a couple of projects over the years but these are the ones that I’m most proud of. If you see something that piques your interest, check out the code and contribute if you have ideas for how it can be improved."
    >
      <ul
        role="list"
